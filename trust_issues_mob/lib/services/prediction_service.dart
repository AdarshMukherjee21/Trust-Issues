...
class PredictionService {
  ...
  // ... [Configuration and checkSms remain same] ...
  ...
  Future<Map<String, dynamic>> explainMessage({
    ...
    // 🔥 REPLACING PREDICTION WITH DETAILED TYPE
    await originalDocRef.update({
      'ai_explanation_ref': aiDocId,
      'prediction': spamType, // Overwriting "SPAM" with "Phishing", etc.
    });

    developer.log('Explanation Synced & Prediction Overwritten.', name: 'PredictionService');
    return explanation;
  }
}